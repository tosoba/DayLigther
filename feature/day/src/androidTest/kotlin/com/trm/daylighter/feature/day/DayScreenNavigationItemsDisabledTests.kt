...
class DayScreenNavigationItemsDisabledTests(
  ...
  fun givenNonReadyChange_thenNavigationBarItemsAreDisabled() {
    with(composeTestRule) {
      ...
      onNodeWithEnumTestTag(DayTestTags.NAVIGATION_SUNRISE_ITEM).assertIsNotEnabled()
      onNodeWithEnumTestTag(DayTestTags.NAVIGATION_SUNSET_ITEM).assertIsNotEnabled()
    }
  }
